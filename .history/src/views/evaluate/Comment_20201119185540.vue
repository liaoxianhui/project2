<template>
  <div>
    ...
    <div class="m20">
      <van-button v-if="flag === 1" type="primary" size="large" @click="submit"
        >提交</van-button
      >
      <van-button v-else type="primary" size="large" @click="submit"
        >返回</van-button
      >
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    getdata() {
      this.pid = JSON.parse(this.$route.query.msg);
