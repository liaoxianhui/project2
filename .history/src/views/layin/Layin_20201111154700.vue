<template>
  <div class="b-image">
    <div class="sign">
      <div class="fw-b fs-20 ce">登录/注册</div>
      <van-form style="background:rgba(255,255,255,.5)">
        ...
        <div class="df" style="background:rgba(255,255,255,.7)">
          <van-field
            v-model="verify1"
            name="验证码"
            label="验证码"
            placeholder="验证码"
          />
          <div v-html="verify" @click="code" style="height:100%"></div>
        </div>
...
.b-image {
  background: url("https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3241474867,349606499&fm=26&gp=0.jpg") no-repeat;
