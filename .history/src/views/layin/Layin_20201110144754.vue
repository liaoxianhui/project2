    ...
    <div class="sign">
      ...
      <van-form @submit="onSubmit">
        ...
        <div class="df">
          ...
          placeholder="手机验证码"
        />
        <van-button type="primary" size="normal" style="width:140px;font-size:12px">发送验证码</van-button>
        </div>
        ...
        <div style="margin: 16px" class=" ta-c">
          <van-button  type="primary" native-type="submit" style="margin-right:20px">
            登录
          </van-button>
