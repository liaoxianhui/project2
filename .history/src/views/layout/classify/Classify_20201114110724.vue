<template>
  <div>
    ...
    <div class="df">
      <div class="pf l0" style="top: 50px">
      ...
      <div class="b1sr oh bw" style="margin-left: 80px">
        <van-tabs v-model="active" swipeable :offset-top="40">
          <van-tab  v-for="(item, index) in gtoud"
            :key="index"
