  ...
  <div>
    <div class="container">
      <div class="city" style="z-index: 999 !important">
        <div v-if="city.length>0" class="van-ellipsis" :alt="city" @click="click">
          {{ city }}
        </div>
        <div v-else class="van-ellipsis" :alt="city" @click="click">正在定位..</div>
    ...
    >
      <div v-for="(item, index) in arr" :key="index">
        <div class="fs-12 pb-10"  v-html="brightenKeyword(item.name,value)"></div>
      </div>
    </div>
  </div>
</template>
